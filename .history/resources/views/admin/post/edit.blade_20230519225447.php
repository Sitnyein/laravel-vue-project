  ...
  <div class="card">
    <div class="card-body">
        ...
        <div class=" form-group">
            ...
            <input type="text" name="name" id="title" value="{{old('name',$postdetail->title)}}" class=" form-control" placeholder="Enter new title">
            @error('name')
        ...
        <div class=" form-group">
            ...
            <input type="file" name="image"  class=" form-contorl"> <br> <br>
