<template>
    <div>
      <div class="d-flex justify-content-center py-3">
        <p class="btn btn-danger text-white mr-4" @click="homeshow">Home</p>
        <p class="btn bg-dark text-white" v-if="!tokenstatus" @click="login()">login</p>
        <p class="btn bg-dark text-white" v-if="tokenstatus" @click="logout()">logout</p>
      </div>
        <main>
            <!-- Whats New Start -->
                                    ...
                                    <div class="properties__button">
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" @click="categorysearch('')" href="details.htmlnav-home" role="tab" aria-controls="nav-home" aria-selected="true">All</a
                            >
                            <a
                              ...
                              aria-selected="false" v-for="(category,index) in categorylist" :key="index" @click="categorysearch(category.id)"
                              >{{category.title}}</a
                            >
                          ...
                          <div class="whats-news-caption">
                            <div class="row">
                              <div class="col-lg-6 col-md-6" v-for="(post,index) in postlist" :key="index">
                                <div class="single-what-news mb-100" v-on:click="detail(post.id)">
                                  <div class="what-img">
                                    <img class=" w-75"
