  ...
  <div class="card">
    <div class="card-body">
        ...
        <div class=" form-group">
            ...
            <input type="text" name="name" id="title" value="{{old('name',$editcategory->title )}}" class=" form-control" placeholder="Enter new title">
            @error('name')
        ...
        <div class=" form-group">
            ...
            <textarea name="description" id="categorytext" class=" form-control" cols="30" rows="10" placeholder="Enter new descrtion"> {{old('description',$editcategory->description)}} </textarea>
            @error('description')
            <div class="text-danger"> {{$message}} </div>
            @enderror
        </div>
